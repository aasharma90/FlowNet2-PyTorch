function [uv, colours, image] = ProjectLaserIntoCamera(image_dir, laser_dir, ins_file, models_dir, extrinsics_dir, image_timestamp)
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  fprintf('**** ProjectLaserIntoCamera ****\n');
  fprintf('Image Timestamp = %s\n', num2str(image_timestamp));
  if image_dir(end) ~= '/'
    image_dir = [image_dir '/'];
  end
...
%   reflectance_vals = reflectance(in_front(in_img));
